...
# word input -> GRU encoder -> output + hidden state
...
# need to read the attention decoder paper lol
...
torch.save(encoder1, 'seq2seq-encoder.pt')
torch.save(attn_decoder1, 'seq2seq-decoder.pt')
